...
public interface ITeamService {
    ...
    boolean isPartOfAnyTeam(Long id, Long teamId);
    ...
    TeamInvitationDecereal respondInvitation(Long invitationId, TeamInvitationRespondCereal cereal) throws NotFoundException, UnauthorizedException, ForbiddenException, ConflictException, BadRequestedExceptions, UnexpectedApiErrorException;
    TeamInvitationDecereal updateInvitation(Long invitationId, TeamInvitationUpdateCereal cereal) throws NotFoundException, UnauthorizedException, ForbiddenException, ConflictException, BadRequestedExceptions, UnexpectedApiErrorException;
}
